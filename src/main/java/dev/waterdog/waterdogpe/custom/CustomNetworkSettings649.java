...
public class CustomNetworkSettings649 extends Bedrock_v649 {
    ...
    protected static final TypeMap<ParticleType> PARTICLE_TYPES = Bedrock_v630.PARTICLE_TYPES.toBuilder()
            .shift(18, 1)
    ...
    protected static final TypeMap<LevelEventType> LEVEL_EVENTS = Bedrock_v630.LEVEL_EVENTS.toBuilder()
            ...
            .replace(3610, LevelEvent.PARTICLE_WIND_EXPLOSION)
            .insert(3611, LevelEvent.PARTICLE_TRIAL_SPAWNER_DETECTION)
            .insert(3612, LevelEvent.PARTICLE_TRIAL_SPAWNER_SPAWNING)
            .insert(3613, LevelEvent.PARTICLE_TRIAL_SPAWNER_EJECTING)
            .insert(3614, LevelEvent.ALL_PLAYERS_SLEEPING)
            .insert(16384, PARTICLE_TYPES)
            .build();

    protected static final EntityDataTypeMap ENTITY_DATA = Bedrock_v630.ENTITY_DATA.toBuilder()
            .update(EntityDataTypes.AREA_EFFECT_CLOUD_PARTICLE, new TypeMapTransformer(PARTICLE_TYPES))
            .build();

    protected static final TypeMap<SoundEvent> SOUND_EVENTS = Bedrock_v630.SOUND_EVENTS.toBuilder()
