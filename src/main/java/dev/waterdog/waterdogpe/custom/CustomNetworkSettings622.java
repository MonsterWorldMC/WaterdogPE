...
public class CustomNetworkSettings622 extends Bedrock_v622 {
    ...
    protected static final TypeMap<EntityFlag> ENTITY_FLAGS = Bedrock_v618.ENTITY_FLAGS.toBuilder()
            .insert(115, EntityFlag.TIMER_FLAG_1)
            .insert(116, EntityFlag.TIMER_FLAG_2)
            .insert(117, EntityFlag.TIMER_FLAG_3)
            .build();

    protected static final EntityDataTypeMap ENTITY_DATA = Bedrock_v618.ENTITY_DATA.toBuilder()
            .update(EntityDataTypes.FLAGS, new FlagTransformer(ENTITY_FLAGS, 0))
            .update(EntityDataTypes.FLAGS_2, new FlagTransformer(ENTITY_FLAGS, 1))
            .build();

    protected static final TypeMap<SoundEvent> SOUND_EVENTS = Bedrock_v618.SOUND_EVENTS.toBuilder()
